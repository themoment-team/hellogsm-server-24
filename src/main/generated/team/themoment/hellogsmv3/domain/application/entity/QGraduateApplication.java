...
/**
 * QGraduateApplication is a Querydsl query type for GraduateApplication
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QGraduateApplication extends EntityPathBase<GraduateApplication> {

    private static final long serialVersionUID = -1342516690L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QGraduateApplication graduateApplication = new QGraduateApplication("graduateApplication");
    ...
    public QGraduateApplication(String variable) {
        this(GraduateApplication.class, forVariable(variable), INITS);
    }

    public QGraduateApplication(Path<GraduateApplication> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QGraduateApplication(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QGraduateApplication(PathMetadata metadata, PathInits inits) {
        this(GraduateApplication.class, metadata, inits);
    }

    public QGraduateApplication(Class<? extends GraduateApplication> type, PathMetadata metadata, PathInits inits) {
